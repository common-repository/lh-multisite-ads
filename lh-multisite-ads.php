<?php
/**
* Plugin Name: LH Multisite Ads
* Plugin URI: https://lhero.org/portfolio/lh-multisite-ads/
* Version: 1.26
* Author: Peter Shaw
* Author URI: https://shawfactor.com
* Network: true
* Description: Allows you to insert ads after paragraphs of your post content throughout your multisite network
* License: GPL2
*/
